...
const professionImages = [
  {
    url: 'https://images.pexels.com/photos/3738339/pexels-photo-3738339.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    caption: 'Hairstylists: Crafting Confidence'
  },
  {
    url: 'https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    caption: 'Makeup Artists: Unleash Your Glow'
  },
  {
    url: 'https://images.pexels.com/photos/274973/pexels-photo-274973.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    caption: 'Photographers: Capturing Moments'
  },
  {
    url: 'https://images.pexels.com/photos/462118/pexels-photo-462118.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    caption: 'Tailors: Stitching Dreams'
  },
  {
    url: 'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    caption: 'Home Decor: Inspire Your Space'
  },
  {
    url: 'https://images.pexels.com/photos/461382/pexels-photo-461382.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    caption: 'Kitchenware Sellers: Cook Up Success'
  },
  {
    url: 'https://images.pexels.com/photos/2983464/pexels-photo-2983464.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    caption: 'Fashion Sellers: Style the World'
  },
  {
    url: 'https://images.pexels.com/photos/298863/pexels-photo-298863.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    caption: 'Shoe & Bag Sellers: Step Up'
  },
  {
    url: 'https://images.pexels.com/photos/461428/pexels-photo-461428.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    caption: 'Handmade Crafts: Create Magic'
  },
  {
    url: 'https://images.pexels.com/photos/169190/pexels-photo-169190.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    caption: 'Event Planners: Celebrate Life'
  },
  {
    url: 'https://images.pexels.com/photos/1552242/pexels-photo-1552242.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    caption: 'Fitness Trainers: Power Up'
  },
  {
    url: 'https://images.pexels.com/photos/3997987/pexels-photo-3997987.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    caption: 'Spa Owners: Relax & Renew'
  },
  {
    url: 'https://images.pexels.com/photos/1181671/pexels-photo-1181671.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    caption: 'Freelancers: Design Your Path'
  }
]
...
export function SignUp() {
  ...
  const [currentIdx, setCurrentIdx] = useState(() => Math.floor(Math.random() * professionImages.length))
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setFade(true)
      setTimeout(() => {
        setCurrentIdx(idx => (idx + 1) % professionImages.length)
        setFade(false)
  ...
  const currentImage = professionImages[currentIdx]
      ...
      <div className="relative hidden lg:block">
        <div className="absolute inset-0 rounded-3xl overflow-hidden">
          <img
            ...
            className={`h-full w-full object-cover transition-opacity duration-700 ${fade ? 'opacity-0' : 'opacity-100'}`}
          />
          <div className="absolute inset-0 bg-gradient-to-br from-primary/80 to-accent/80 mix-blend-multiply"></div>
          <div className="absolute inset-0 flex flex-col items-center justify-center p-8">
            <div className="bg-white/20 rounded-2xl px-6 py-4 backdrop-blur-md shadow-lg">
              <h3 className="text-2xl font-bold text-white drop-shadow-lg animate-fade-in-up">{currentImage.caption}</h3>
              <p className="text-base text-white/80 mt-2 animate-fade-in-up">Discover Your Glow</p>
            </div>
          </div>
        </div>
      </div>
